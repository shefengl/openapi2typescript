        ...
        return Object.keys(this.apiData)
            ...
            !api.path.includes('${'))
                ...
                try {
                    ...
                    const escapedHeaderParams = ((params || {}).header || []).map((ele, index) => (Object.assign(Object.assign({}, ele), { alias: `header${index}` })));
                    ...
                    const finalParams = escapedPathParams && escapedPathParams.length
                        ? escapedHeaderParams && escapedHeaderParams.length ? Object.assign(Object.assign({}, params), { path: escapedPathParams, header: escapedHeaderParams }) : Object.assign(Object.assign({}, params), { path: escapedPathParams })
                        : escapedHeaderParams && escapedHeaderParams.length ? Object.assign(Object.assign({}, params), { path: escapedPathParams, header: escapedHeaderParams }) : params;
                    // 处理 query 中的复杂对象
